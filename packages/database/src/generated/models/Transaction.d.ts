...
export type TransactionWhereInput = {
    ...
    token?: Prisma.StringFilter<'Transaction'> | string;
    from?: Prisma.StringNullableFilter<'Transaction'> | string | null;
...
export type TransactionScalarWhereWithAggregatesInput = {
    ...
    token?: Prisma.StringWithAggregatesFilter<'Transaction'> | string;
    from?: Prisma.StringNullableWithAggregatesFilter<'Transaction'> | string | null;
...
export type TransactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'signature' | 'type' | 'amount' | 'token' | 'from' | 'to' | 'timestamp', ExtArgs['result']['transaction']>;
...
export interface TransactionFieldRefs {
    ...
    readonly token: Prisma.FieldRef<'Transaction', 'String'>;
