...
// @ts-nocheck
/*
 * This file exports the `DiscoveredPool` model and its related types.
 *
 ...
 *
 */
export type DiscoveredPoolModel =
  runtime.Types.Result.DefaultSelection<Prisma.$DiscoveredPoolPayload>;
...
export type DiscoveredPoolAggregateArgs<
...
> = {
   ...
   */
  orderBy?:
    | Prisma.DiscoveredPoolOrderByWithRelationInput
    | Prisma.DiscoveredPoolOrderByWithRelationInput[];
  /**
...
export type GetDiscoveredPoolAggregateType<T extends DiscoveredPoolAggregateArgs> = {
  [P in keyof T & keyof AggregateDiscoveredPool]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDiscoveredPool[P]>
    : Prisma.GetScalarType<T[P], AggregateDiscoveredPool[P]>;
};

export type DiscoveredPoolGroupByArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  where?: Prisma.DiscoveredPoolWhereInput;
  orderBy?:
    | Prisma.DiscoveredPoolOrderByWithAggregationInput
    | Prisma.DiscoveredPoolOrderByWithAggregationInput[];
...
type GetDiscoveredPoolGroupByPayload<T extends DiscoveredPoolGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DiscoveredPoolGroupByOutputType, T['by']> & {
      [P in keyof T & keyof DiscoveredPoolGroupByOutputType]: P extends '_count'
        ? T[P] extends boolean
          ? number
          : Prisma.GetScalarType<T[P], DiscoveredPoolGroupByOutputType[P]>
        : Prisma.GetScalarType<T[P], DiscoveredPoolGroupByOutputType[P]>;
    }
  >
>;
...
export type DiscoveredPoolWhereInput = {
  ...
  initialTvl?:
    | Prisma.DecimalFilter<'DiscoveredPool'>
    | runtime.Decimal
...
export type DiscoveredPoolScalarWhereWithAggregatesInput = {
  AND?:
    | Prisma.DiscoveredPoolScalarWhereWithAggregatesInput
    | Prisma.DiscoveredPoolScalarWhereWithAggregatesInput[];
  ...
  initialTvl?:
    | Prisma.DecimalWithAggregatesFilter<'DiscoveredPool'>
    | runtime.Decimal
    | runtime.DecimalJsLike
    | number
    | string;
...
export type DiscoveredPoolSelect<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
...
export type DiscoveredPoolSelectCreateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
    id?: boolean;
...
export type DiscoveredPoolSelectUpdateManyAndReturn<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
    id?: boolean;
...
export type DiscoveredPoolOmit<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
...
export type $DiscoveredPoolPayload<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  name: 'DiscoveredPool';
  objects: {};
...
export type DiscoveredPoolGetPayload<
  S extends boolean | null | undefined | DiscoveredPoolDefaultArgs,
> = runtime.Types.Result.GetResult<Prisma.$DiscoveredPoolPayload, S>;

export type DiscoveredPoolCountArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = Omit<DiscoveredPoolFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
  select?: DiscoveredPoolCountAggregateInputType | true;
};

export interface DiscoveredPoolDelegate<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
  GlobalOmitOptions = {},
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>['model']['DiscoveredPool'];
    meta: { name: 'DiscoveredPool' };
  };
  /**
   ...
   * })
   */
  findUnique<T extends DiscoveredPoolFindUniqueArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolFindUniqueArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
      'findUnique',
      GlobalOmitOptions
    > | null,
   ...
   * })
   */
  findUniqueOrThrow<T extends DiscoveredPoolFindUniqueOrThrowArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolFindUniqueOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirst<T extends DiscoveredPoolFindFirstArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolFindFirstArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirstOrThrow<T extends DiscoveredPoolFindFirstOrThrowArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolFindFirstOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   *
   */
  findMany<T extends DiscoveredPoolFindManyArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolFindManyArgs<ExtArgs>>,
   ...
   *
   */
  create<T extends DiscoveredPoolCreateArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolCreateArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   *
   */
  createMany<T extends DiscoveredPoolCreateManyArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolCreateManyArgs<ExtArgs>>,
   ...
   *
   */
  createManyAndReturn<T extends DiscoveredPoolCreateManyAndReturnArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolCreateManyAndReturnArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   *
   */
  delete<T extends DiscoveredPoolDeleteArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolDeleteArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   *
   */
  update<T extends DiscoveredPoolUpdateArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolUpdateArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   *
   */
  deleteMany<T extends DiscoveredPoolDeleteManyArgs>(
    args?: Prisma.SelectSubset<T, DiscoveredPoolDeleteManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateMany<T extends DiscoveredPoolUpdateManyArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolUpdateManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateManyAndReturn<T extends DiscoveredPoolUpdateManyAndReturnArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolUpdateManyAndReturnArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   * })
   */
  upsert<T extends DiscoveredPoolUpsertArgs>(
    args: Prisma.SelectSubset<T, DiscoveredPoolUpsertArgs<ExtArgs>>,
  ): Prisma.Prisma__DiscoveredPoolClient<
    runtime.Types.Result.GetResult<
      Prisma.$DiscoveredPoolPayload<ExtArgs>,
      T,
   ...
   * })
   **/
  count<T extends DiscoveredPoolCountArgs>(
    args?: Prisma.Subset<T, DiscoveredPoolCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DiscoveredPoolCountAggregateOutputType>
      : number
  >;
   ...
   * })
   **/
  aggregate<T extends DiscoveredPoolAggregateArgs>(
    args: Prisma.Subset<T, DiscoveredPoolAggregateArgs>,
  ): Prisma.PrismaPromise<GetDiscoveredPoolAggregateType<T>>;
   ...
   **/
  groupBy<
    T extends DiscoveredPoolGroupByArgs,
  ...
  >(
    args: Prisma.SubsetIntersection<T, DiscoveredPoolGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors
    ? GetDiscoveredPoolGroupByPayload<T>
 ...
 */
export interface Prisma__DiscoveredPoolClient<
  T,
  Null = never,
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
  GlobalOmitOptions = {},
 ...
 */
export type DiscoveredPoolFindUniqueArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type DiscoveredPoolFindUniqueOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolFindFirstArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolFindFirstOrThrowArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolFindManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolCreateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolCreateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type DiscoveredPoolCreateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolUpdateArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolUpdateManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.DiscoveredPoolUpdateManyMutationInput,
    Prisma.DiscoveredPoolUncheckedUpdateManyInput
  >;
  /**
 ...
 */
export type DiscoveredPoolUpdateManyAndReturnArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolUpsertArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolDeleteArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
 ...
 */
export type DiscoveredPoolDeleteManyArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type DiscoveredPoolDefaultArgs<
  ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   * Select specific fields to fetch from the DiscoveredPool
