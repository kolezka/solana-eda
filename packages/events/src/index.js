...
// Type guards
export function isBurnEvent(event) {
    return event.type === 'BURN_DETECTED';
}
export function isLiquidityEvent(event) {
    return event.type === 'LIQUIDITY_CHANGED';
}
export function isTradeEvent(event) {
    return event.type === 'TRADE_EXECUTED';
}
export function isPositionOpenedEvent(event) {
    return event.type === 'POSITION_OPENED';
}
export function isPositionClosedEvent(event) {
    return event.type === 'POSITION_CLOSED';
}
export function isWorkerStatusEvent(event) {
    return event.type === 'WORKER_STATUS';
}
export function isPriceUpdateEvent(event) {
    return event.type === 'PRICE_UPDATE';
}
export function isDEXQuoteComparisonEvent(event) {
    return event.type === 'DEX_QUOTE_COMPARISON';
}
export function isMarketDiscoveredEvent(event) {
    return event.type === 'MARKET_DISCOVERED';
}
export function isTokenValidatedEvent(event) {
    return event.type === 'TOKEN_VALIDATED';
}
export function isPoolDiscoveredEvent(event) {
...
export function createBurnEvent(data) {
    return {
        type: 'BURN_DETECTED',
...
export function createLiquidityEvent(data) {
    return {
...
export function createTradeEvent(data) {
    return {
        type: 'TRADE_EXECUTED',
        timestamp: new Date().toISOString(),
        id: `trade-${Date.now()}`,
...
export function createPositionOpenedEvent(data) {
    return {
...
export function createPositionClosedEvent(data) {
    return {
...
export function createWorkerStatusEvent(data) {
    return {
        type: 'WORKER_STATUS',
        timestamp: new Date().toISOString(),
        id: `worker-${Date.now()}`,
...
export function createPriceUpdateEvent(data) {
    return {
        type: 'PRICE_UPDATE',
        timestamp: new Date().toISOString(),
        id: `price-${Date.now()}`,
...
export function createDEXQuoteComparisonEvent(data) {
    return {
...
export function createMarketDiscoveredEvent(data) {
    return {
...
export function createTokenValidatedEvent(data) {
    return {
...
export function createPoolDiscoveredEvent(data) {
    return {
